...
public:
	...
	int setHeuristic() {
		...
		if (board[0][7] == 3 - player) {
			...
			if (board[1][7] == player || board[0][6] == player) {
				heuristic += 30;
			}
		}
		if (board[7][0] == 3 - player) {
			heuristic -= 50;
			if (board[6][1] == 3 - player) {
				heuristic -= 50;
			}
			if (board[6][0] == 3 - player || board[7][1] == 3 - player) {
				heuristic -= 30;
			}
		}
			...
			if (board[6][0] == player || board[7][1] == player) {
				heuristic += 30;
			}
		}
		if (board[7][7] == 3 - player) {
			heuristic -= 50;
			if (board[6][6] == 3 - player) {
				heuristic -= 50;
			}
			if (board[6][7] == 3 - player || board[7][6] == 3 - player) {
				heuristic -= 30;
			}
		}
			...
			if (board[6][7] == player || board[7][6] == player) {
				heuristic += 30;
			}
		}
